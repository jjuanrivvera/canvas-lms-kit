...
/**
 * Data Transfer Object for updating discussion topics in Canvas LMS
 *
 * This DTO handles the updating of existing discussion topics with partial
 * field updates supported by the Canvas API.
 *
 * @package CanvasLMS\Dto\DiscussionTopics
 */
class UpdateDiscussionTopicDTO extends AbstractBaseDto implements DTOInterface
{
    /**
