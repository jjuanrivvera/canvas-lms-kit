 ...
 *
 * Data Transfer Object for creating appointment groups in Canvas LMS.
 * Handles the transformation of appointment group data into the multipart
 * format expected by the Canvas API.
 *
 * @package CanvasLMS\Dto\AppointmentGroups
 */
class CreateAppointmentGroupDTO extends AbstractBaseDto
{
    /**
