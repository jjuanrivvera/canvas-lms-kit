...
namespace CanvasLMS\Dto\Outcomes\Outcome;
 ...
 */
class CreateOutcomeDTO extends AbstractBaseDto
{
    ...
    public function withCalculationMethod(string $method, ?int $calculationInt = null): self
    {
        ...
        if (!$this->validateCalculationMethod()) {
            throw new \InvalidArgumentException("Invalid calculation method: {$method}");
        }
