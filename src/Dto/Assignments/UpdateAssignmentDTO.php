 ...
 *
 * This DTO handles the update of existing assignments with all the necessary
 * fields supported by the Canvas API. All fields are optional since this is
 * for updating existing assignments.
 *
 * @package CanvasLMS\Dto\Assignments
 */
class UpdateAssignmentDTO extends AbstractBaseDto implements DTOInterface
{
    /**
