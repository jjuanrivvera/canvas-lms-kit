 ...
 *
 * @see https://canvas.instructure.com/doc/api/rubrics.html#method.RubricsController.update
 */
class UpdateRubricDTO extends AbstractBaseDto implements DTOInterface
{
     ...
     */
    public ?bool $skipUpdatingPointsPossible = null;
