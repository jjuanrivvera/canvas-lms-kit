 ...
 *
 * @see https://canvas.instructure.com/doc/api/rubrics.html#method.RubricAssociationsController.create
 */
class CreateRubricAssociationDTO extends AbstractBaseDto implements DTOInterface
{
