 ...
 *
 * @see https://canvas.instructure.com/doc/api/rubrics.html#method.RubricAssessmentsController.create
 */
class CreateRubricAssessmentDTO extends AbstractBaseDto implements DTOInterface
{
