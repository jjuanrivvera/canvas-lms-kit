 ...
 *
 * Handles Canvas API key update parameters following the Canvas API specification.
 ...
 *
 * @see https://canvas.instructure.com/doc/api/developer_keys.html#method.developer_keys.update
 */
class UpdateDeveloperKeyDTO extends AbstractBaseDto implements DTOInterface
{
     ...
     * Only includes non-null values to allow partial updates
     *
     ...
     *
     * @return bool True if at least one field has been set
     */
    public function hasUpdates(): bool
    {
        $properties = get_object_vars($this);
        unset($properties['apiPropertyName']); // Exclude the protected property
     ...
     *
     * @return array<string> List of property names that have non-null values
     */
    ...
    {
        if (property_exists($this, $field) && $field !== 'apiPropertyName') {
            $this->{$field} = null;
        }
