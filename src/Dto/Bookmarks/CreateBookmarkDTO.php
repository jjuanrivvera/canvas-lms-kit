 ...
 *
 * This DTO handles the transformation of bookmark creation data
 * into the format expected by the Canvas API.
 */
class CreateBookmarkDTO extends AbstractBaseDto implements DTOInterface
{
    /**
